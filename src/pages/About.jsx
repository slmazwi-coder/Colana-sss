    ...
    <main className="flex-1 section-pad" style={{ background: '#FFFDF5' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-20">
          <div>
            <h2 className="font-display font-bold text-2xl mb-6" style={{ color: '#6B2D15' }}>Our School</h2>
        ...
        {/* Uniform */}
        <div className="mb-20">
          <h2 className="font-display font-bold text-2xl mb-6" style={{ color: '#6B2D15' }}>School Uniform</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card" style={{ borderLeft: '4px solid #DAA520' }}>
              <h3 className="font-display font-bold text-lg mb-3" style={{ color: '#6B2D15' }}>Girls</h3>
            ...
            <div className="card" style={{ borderLeft: '4px solid #DAA520' }}>
              <h3 className="font-display font-bold text-lg mb-3" style={{ color: '#6B2D15' }}>Boys</h3>
              <p className="text-sm" style={{ color: '#374151' }}>
