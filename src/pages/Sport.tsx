    ...
    <div className="py-12 sm:py-16 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-lg text-gray-600 mb-12 max-w-3xl mx-auto">
          Colana SSS offers structured sport programs to develop teamwork, fitness, and discipline.
        </p>
            ...
            {sports.map((s) => (
              <div key={s.name} className="bg-gray-50 rounded-3xl border border-gray-100 p-7">
                <div className="flex items-center gap-3 mb-3">
                  <div className="p-3 rounded-2xl bg-white border border-gray-200 text-[#6B2D15]">
                    <s.icon size={22} />
                  </div>
