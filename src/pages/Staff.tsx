...
const StaffCard = ({ member }: { member: typeof staffData[number] }) => (
  ...
  >
    ...
    <h3 className="text-sm font-bold leading-tight" style={{ color: '#6B2D15' }}>
      {member.name}
    </h3>
    ...
    {member.subject && (
      <span
        ...
        style={{ background: '#FDF5E6', color: '#6B2D15', border: '1px solid #DAA520' }}
      >
        {member.subject}
      </span>
    )}
    ...
    <div className="min-h-screen py-12 px-4" style={{ background: '#FDF5E6' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-extrabold tracking-tight mb-3" style={{ color: '#6B2D15' }}>
            Our Staff
          </h1>
          <div className="w-16 h-1 mx-auto rounded-full mb-4" style={{ background: '#DAA520' }} />
          <p className="text-gray-500 text-base max-w-2xl mx-auto">
            Meet the dedicated team of educators and support staff at Colana Senior Secondary School.
          </p>
        </div>
            ...
            <button
              ...
              style={
                activeCategory === cat
                  ...
                  : { background: '#fff', color: '#6B2D15', border: '1px solid rgba(218,165,32,0.4)' }
              }
            >
              {cat}
            </button>
