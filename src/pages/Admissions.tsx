...
const inp =
  'border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#DAA520]/40 focus:border-[#6B2D15] transition w-full bg-white';
...
const SectionHeading = ({ icon, title }: { icon: React.ReactNode; title: string }) => (
  <div className="flex items-center gap-2 pb-2 border-b border-gray-200 mb-4">
    <span className="text-[#6B2D15]">{icon}</span>
  ...
  <div className="flex items-center gap-2">
    <div
      className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-black border-2 transition-all
        ${done   ? 'bg-[#DAA520] border-[#6B2D15] text-white'
        : active ? 'bg-white border-white text-[#6B2D15]'
  ...
  if (submitted) {
    return (
      <div className="py-20 flex items-center justify-center min-h-[60vh]">
        ...
        >
          <div className="w-20 h-20 bg-[#FFF3CC] text-[#6B2D15] rounded-full flex items-center justify-center mx-auto mb-6">
            <CheckCircle size={48} />
          </div>
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Application Submitted!</h2>
          <p className="text-gray-600 mb-8">
            Thank you for applying to Colana Senior Secondary School. We have received your application and will be in contact shortly.
          </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
              <div>
                ...
                <p className="text-white/70 text-sm mt-1">
                  Colana Senior Secondary School &nbsp;·&nbsp; Igoga Location, Matatiele 4730
                </p>
              </div>
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="text-sm font-semibold text-[#6B2D15] underline underline-offset-2"
                      >
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {file && <div className="text-xs text-[#6B2D15] truncate mt-0.5">{file.name}</div>}
                                {!file && <div className="text-xs text-gray-400 mt-0.5">No file chosen</div>}
                              </div>
                              <label className="shrink-0 text-xs font-bold text-[#6B2D15] cursor-pointer hover:underline">
                                {file ? 'Change' : 'Upload'}
                                <input
                                  type="file"
                                  className="hidden"
