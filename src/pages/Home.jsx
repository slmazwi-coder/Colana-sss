...
export default function Home() {
  return (
    <main className="flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <div key={to} className="card flex gap-4 items-start"
                ...
                <div className="p-2.5 rounded-xl shrink-0" style={{ background: 'rgba(218,165,32,0.12)', color: '#6B2D15' }}>
                  <Bell size={20} />
                </div>
                <div>
                  ...
                  <h3 className="font-display font-bold text-lg mb-1" style={{ color: '#6B2D15' }}>{title}</h3>
      ...
      <section className="section-pad" style={{ background: '#FDF5E6' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="section-title">Why Colana SSS?</h2>
            ...
            {PILLARS.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="card text-center">
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center mx-auto mb-4"
                  style={{ background: 'rgba(218,165,32,0.12)', color: '#6B2D15' }}>
                  <Icon size={24} />
                </div>
                <h3 className="font-display font-bold mb-2" style={{ color: '#6B2D15' }}>{title}</h3>
      ...
      <section className="section-pad" style={{ background: '#fff' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-3 max-w-xl mx-auto text-sm" style={{ color: '#4b5563' }}>
              Colana SSS offers three academic streams for Grade 8–12 learners.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={title} className="card" style={{ borderTop: '4px solid #DAA520' }}>
                <h3 className="font-display font-bold text-xl mb-3" style={{ color: '#6B2D15' }}>{title}</h3>
      ...
      <section className="section-pad" style={{ background: '#FDF5E6' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { src: '/assets/campus.jpg', alt: 'Campus life at Colana SSS' },
      ...
      {/* Motto CTA */}
      <section style={{ background: '#6B2D15', borderTop: '4px solid #DAA520', borderBottom: '4px solid #DAA520' }}>
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-base mb-8" style={{ color: 'rgba(218,165,32,0.7)' }}>
            Rise up and progress — join the Colana SSS family and discover what you're truly capable of.
          </p>
