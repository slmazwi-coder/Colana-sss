...
const SLIDES = [
  { caption: 'Vuka Ulwe Uqaqambe',             sub: 'Rise Up and Progress' },
...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden diagonal-strip" style={{ minHeight: '88vh', background: '#6B2D15' }}>
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0" style={{ background: 'rgba(107,45,21,0.82)' }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center" style={{ minHeight: '78vh' }}>
        <div className="max-w-3xl pt-16 pb-8">
          ...
          <p className="text-lg mb-8 max-w-xl delay-1 fade-up" style={{ color: 'rgba(218,165,32,0.7)' }}>
            Colana Senior Secondary School — Eastern Cape, South Africa.
          </p>
